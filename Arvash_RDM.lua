...
------------------------------------LOCKSTYLE------------------------------------------
local lockstyle = 9 -- Uses the in-game gearsets! Set # to desired lockstyle look!
...
--------------------- FASTCAST SETS --------------------
    ...
    ammo="Sapience Orb",
    head="Atrophy Chapeau +3",
    body={ name="Taeon Tabard", augments={'Pet: Accuracy+21 Pet: Rng. Acc.+21','Pet: "Dbl. Atk."+4','Pet: Damage taken -3%',}},
...
--------------------- MAGIC SETS -----------------------
    ...
    body="Atrophy Tabard +3",
    hands={ name="Telchine Gloves", augments={'Mag. Acc.+25','"Cure" spellcasting time -7%','MND+10',}},
    legs="Atrophy Tights +3",
