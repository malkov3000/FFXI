...
----------------------- WEAPON SETS --------------------
	...
	WEP_Set_Names = {"DarkArts","LightArts","Enhancing"}
...
--------------------- FASTCAST SETS --------------------
	...
	sets.fc['Elemental Magic'] = {right_ring="Mallquis Ring",}
	sets.fc['Dark Magic'] = {}
...
--------------------- MAGIC SETS -----------------------
    ...
    back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+6','"Mag.Atk.Bns."+10','Damage taken-1%',}},
}
